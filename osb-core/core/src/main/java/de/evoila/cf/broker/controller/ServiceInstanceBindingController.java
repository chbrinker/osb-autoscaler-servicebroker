...
public class ServiceInstanceBindingController extends BaseController {
	...
	public ResponseEntity<ServiceInstanceBindingResponse> bindServiceInstance(
			...
			ServiceBrokerException, ServiceDefinitionDoesNotExistException, ServiceInstanceBindingException {
	...
	public ResponseEntity<String> deleteServiceInstanceBinding(@PathVariable("instanceId") String instanceId,
		...
		} catch (ServerviceInstanceBindingDoesNotExistsException | ServiceInstanceBindingException e) {
