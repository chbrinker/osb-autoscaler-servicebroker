...
class ServiceKeysController extends BaseController {
    ...
    @PostMapping(value = "")
    public ResponseEntity<ServiceInstanceBinding> createServiceKey (@PathVariable String serviceInstanceId) throws ServiceInstanceDoesNotExistException, ServiceBrokerException, ServiceInstanceBindingExistsException, ServiceDefinitionDoesNotExistException, ServiceInstanceBindingException {
    ...
    public ResponseEntity delete (@PathVariable String serviceInstanceId, @PathVariable String serviceBindingId) throws ServerviceInstanceBindingDoesNotExistsException, ServiceBrokerException, ServiceInstanceBindingException {
